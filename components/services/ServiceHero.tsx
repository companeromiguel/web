...
import { FilePlus2, Gauge, CreditCard, Wrench, Droplets, Power, RefreshCw, UserRoundPen, MessageSquare, BadgePercent, type LucideIcon } from "lucide-react";

const icons: Record<string, LucideIcon> = {
  "new-water-application": FilePlus2,
  "meter-reading": Gauge,
  payment: CreditCard,
  "change-ball-valve": Wrench,
  "leak-repair": Wrench,
  "water-supply": Droplets,
  "temporary-disconnection": Power,
  reconnection: RefreshCw,
  "change-name-address": UserRoundPen,
  "change-meter": Gauge,
  "senior-citizen-discount": BadgePercent,
  feedback: MessageSquare,
};

export default function ServiceHero({ title, description, slug }: { title: string; description: string; slug: string }) {
  const Icon = icons[slug] ?? Droplets;
    ...
    <div className={styles.inner}>
      ...
      <div className={styles.content}>
        ...
        <nav aria-label="Breadcrumb" className={styles.breadcrumb}>
          ...
          <span>Services</span><span aria-hidden="true">/</span>
