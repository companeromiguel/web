        ...
        <section aria-labelledby="guide-heading" className="mt-14">
          ...
          <div className="space-y-8">
            {referencePages.map(({ page, title, src, width, height }) => (
                <article key={page} className="overflow-hidden border border-[#E8EEF2] bg-white shadow-sm">
                  <div className="flex items-center justify-between border-b border-[#E8EEF2] bg-[#F7FAFB] px-5 py-3">
                    <h3 className="font-heading text-sm font-semibold text-[#2A2A29]">{title}</h3>
                    <span className="text-xs font-medium text-[#2A2A29]/50">Page {page}</span>
                  </div>
